            ...
            <div class="col-sm-8 col-sm-offset-2">
                ...
                <div class="wizard-container">
                    ...
                    <div class="card wizard-card" data-color="orange" id="wizardProfile">
                        <form action="post" method="{{route('vaccination.store')}}" enctype="multipart/form-data">
                        @csrf
                        {{ csrf_field() }}
                        ...
                        <!--        You can switch ' data-color="orange" '  with one of the next bright colors: "blue", "green", "orange", "red"          -->
                            ...
                            <div class="wizard-header">
                                <h3>
                                    <b>Agendamento</b> Vacinação <br>
                                    <small>Essa informação nos facilitará na Vacinação</small>
                                </h3>
                            </div>
                            ...
                            <div class="wizard-navigation">
                                <ul>
                                    ...
                                    <li><a href="#account" data-toggle="tab">Vacinação</a></li>
                            ...
                            <div class="tab-content">
                                <div class="tab-pane" id="about">
                                    <div class="row">
                                        <h4 class="info-text"> Informações básica para a vacinação </h4>
                                        ...
                                        <div class="col-sm-10 col-sm-offset-1">
                                            <div class="col-sm-4">
                                                <div class="choice" data-toggle="wizard-checkbox">
                                                    <input type="checkbox" name="vacinacao" value="Covid">
                                                    <div class="icon">
                                            ...
                                            <div class="col-sm-4">
                                                <div class="choice" data-toggle="wizard-checkbox">
                                                    <input type="checkbox" name="vacinacao" value="Gripe">
                                                    <div class="icon">
                                            ...
                                            <div class="col-sm-4">
                                                <div class="choice" data-toggle="wizard-checkbox">
                                                    <input type="checkbox" name="vacinacao" value="Sarna">
                                                    <div class="icon">
