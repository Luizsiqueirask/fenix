 ...
 * for events that are broadcast by Laravel. Echo and collection broadcasting
...
;(function() {
  ...
  var runInContext = (function runInContext(context) {
     ...
     * chain sequences. Methods that operate on and return arrays, collection,
     ...
     * [empty collection](https://en.wikipedia.org/wiki/Empty_set) because
     * [everything is true](https://en.wikipedia.org/wiki/Vacuous_truth) of
     * elements of empty collection.
     *
     * @static
     * @memberOf _
     * @since 0.1.0
     ...
     *
     * // Invoke `renewToken` when the click collection is fired, but not more than once every 5 minutes.
     ...
     * jQuery-like collection are considered empty if they have a `length` of `0`.
